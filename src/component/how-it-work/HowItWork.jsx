            ...
            <div className="howitwork-wrapper">
                ...
                <div className="howitwork-wrapper-item">
                    <div className="how-title">
                        <h3>1.Under CediConvert Service, Provide GHS Payment Details.</h3>
                        <img src="https://res.cloudinary.com/dypj8zqbm/image/upload/v1622131853/Vector_12_2_gtlefk.png" alt="line-connector" class="firstLineConnector d-none d-lg-block" width="392px"></img>
                    </div>
                    <div className="">
                    <img src="https://res.cloudinary.com/dypj8zqbm/image/upload/v1626866176/Mask_Group_1_1_hlhdmk.png" alt="phone-advert" width="434px" />
                    </div>
                </div>
                <div className="howitwork-wrapper-item">
                    <div className="">
